...
(function() {
    ...
    const Factory3ContrastModule = {
        init: function() {
            ...
            elements.dateText = document.getElementById('gf3ContrastDateText');
            elements.prevBtn = document.getElementById('gf3ContrastPrevBtn');
            elements.nextBtn = document.getElementById('gf3ContrastNextBtn');
            elements.todayBtn = document.getElementById('gf3ContrastTodayBtn');
            elements.editBtn = document.getElementById('gf3ContrastEditBtn');
            elements.saveBtn = document.getElementById('gf3ContrastSaveBtn');
            elements.excelBtn = document.getElementById('gf3ContrastExcelBtn');
            ...
            state.fp = flatpickr('#gf3ContrastFlatpickr', {
                locale: 'ko',
                dateFormat: 'Y-m-d',
    ...
    window.Factory3ContrastModule = Factory3ContrastModule;

    document.addEventListener('DOMContentLoaded', function() {
        Factory3ContrastModule.init();
    });
})();
